...
class ModifyPropertyOpportunitiesUseUserId extends Migration
{
    public function up()
    {
        Schema::table('property_opportunities', function (Blueprint $table) {
            // Supprimer l'ancienne contrainte de clé étrangère
            $table->dropForeign('po_id_location_foreign');
            
            // Supprimer l'index unique qui utilise id_location
            $table->dropUnique('po_loc_prop_opp_unique');
        ...
        Schema::table('property_opportunities', function (Blueprint $table) {
            ...
            $table->unique(['user_id', 'property_listing_id', 'opportunity_id'], 'po_user_prop_opp_unique');
        ...
        DB::statement('
            UPDATE property_opportunities po
            INNER JOIN users u ON po.id_location = u.id_location
            SET po.user_id = u.id
    ...
    public function down()
    {
        ...
        DB::statement('
            ...
            SET po.id_location = u.id_location
        ');
        ...
        Schema::table('property_opportunities', function (Blueprint $table) {
            ...
            $table->dropUnique('po_user_prop_opp_unique');
