...
<body>
                            ...
                            <tr data-submission-id="{{ $submission['id'] ?? '' }}">
                                ...
                                <td class="action-menu">
                                    @if(!empty($submission['externalContactId']))
                                        <button class="action-button submission-view-button" data-contact-id="{{ $submission['externalContactId'] }}" onclick="viewCentrisSubmissionContact(event)" title="Voir le contact">
    ...
    <script>
        ...
        function viewCentrisSubmissionContact(event) {
            event.stopPropagation();
